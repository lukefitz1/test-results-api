...
RSpec.describe ScenariosController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new scenario" do

        post :create, params: {scenario: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(scenario_url(Scenario.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new scenario" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the scenario" do
        scenario = Scenario.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the scenario" do
        scenario = Scenario.create! valid_attributes
